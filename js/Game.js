class Game 
{
  ...
  showFuelBar() 
  {
    ...
    fill("white")
    rect(widht / 2 - 100, height - player, positionY - 350,185, 20 );
    fill("#ffc400");
    rect(widht / 2 - 100, height - player, positionY - 350,player.fuel, 20 );
    noStroke();
    pop();
  ...
  showRank() 
  {
    swal({
      //title: `Incrível!${"\n"}Rank${"\n"}${player.rank}`,
      title: `Incrível!${"\n"}${player.rank}º lugar`,
      text: "Você conseguiu alcançar a linha de chegada com sucesso!",
      imageUrl:
  ...
  gameOver() 
  {
    swal({
      title: `Fim de Jogo`,
      text: "seu carro foi de americanas!",
      imageUrl:
